...
const MarqueeItem = () => (
    <div className="flex items-center space-x-12 px-6">
        <span>AI Career Benchmarking</span> <span className="text-primary/60">✦</span>
        <span>Real-time Skill Gap Analysis</span> <span className="text-secondary/60">✦</span>
        <span>30-Day Learning Roadmaps</span> <span className="text-primary/60">✦</span>
        <span>Verified Readiness Scores</span> <span className="text-secondary/60">✦</span>
        <span>Industry Standard Alignment</span> <span className="text-primary/60">✦</span>
    </div>
);
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <MagneticButton as="a" href="/dashboard" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
                  Go to Dashboard
                </MagneticButton>
              </div>
